    ...
    <body class="cm-no-transition cm-1-navbar">
        ...
        <div id="global">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img src="<?php echo base_url();?>assets/demo/assets/img/weather.jpg" alt="Less support" class="img-responsive">
                                <br>
                                <p>Todays weather and some random text...blaa.blla..blaaa.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img src="<?php echo base_url();?>assets/demo/assets/img/Calender.png" alt="Responsive across devices" class="img-responsive">
                                <br>
                                <p>calender blallblala.....</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <img src="<?php echo base_url();?>assets/demo/assets/img/todo.png" alt="Components" class="img-responsive">
                                <br>
                ...
                <h1>Hi <?php echo $persons->userName;?>, Welcome to Login you as a Administrator <?php echo anchor('login/logout', 'Logout');?></h1>
            </div>
